...
var PriorityScheduler = /** @class */ (function (_super) {
    __extends(PriorityScheduler, _super);
    function PriorityScheduler(processTable) {
        var _this = _super.call(this, processTable) || this;
        _this.processTable = processTable;
        _this.queue = []; // All processes PIDs by order
        return _this;
    }
    PriorityScheduler.prototype.run = function () {
    ...
    PriorityScheduler.prototype.onNewProcess = function () {
        // EventBus.on("process:new", (pid) => {
        // })
    };
    PriorityScheduler.prototype.moveProcessToBack = function () {
    ...
    PriorityScheduler.prototype.reOrderByPriority = function () {
